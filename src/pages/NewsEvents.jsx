  ...
  return (
    <div id="newsEvent" className="container-fluid bg-primary bg-testimonial fadeInUp"  style={{"paddingTop": "40px"}} data-wow-delay="0.1s">
            <div className="nae" >
                ...
                <a href="https://www.trybooking.com/events/landing/1212114" target="_blank" rel="noreferrer" className="btn btn-secondary1 py-md-3 px-md-5 animated slideInRight">Book</a>
            </div>
            <div className="nae" >
                ...
                <br />
                <a href="mailto:info@vsnh.org.au" target="_blank" className="btn btn-secondary1 py-md-3 px-md-5 animated slideInRight" rel="noreferrer">Book</a>
            </div>
    </div>
  )
};
